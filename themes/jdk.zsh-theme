...
# For git plugin
ZSH_THEME_GIT_PROMPT_PREFIX="%B%F{214} ±(%{$reset_font%}"
ZSH_THEME_GIT_PROMPT_SUFFIX="%B%F{214}) %{$reset_font%}"
ZSH_THEME_GIT_PROMPT_DIRTY="*"
ZSH_THEME_GIT_PROMPT_CLEAN=""

ZSH_THEME_GIT_PROMPT_MERGING="%B%F{219} M"
ZSH_THEME_GIT_PROMPT_REBASING="%B%F{219} R"
ZSH_THEME_GIT_PROMPT_BISECTING="%B%F{219} B"
ZSH_THEME_GIT_PROMPT_CHERRYPICKING="%B%F{219} C"

# For mercurial plugin
ZSH_THEME_HG_PROMPT_PREFIX="%B%F{214} ☿(%{$reset_font%}"
ZSH_THEME_HG_PROMPT_SUFFIX="%B%F{214}) %{$reset_font%}"
